...
#if !defined(__CINT__)
ClassImp(TEventNumbers)
#endif

TEventNumbers::TEventNumbers(){

}

TEventNumbers::TEventNumbers(int run){
...
void TEventNumbers::SetEventNumbers(int run){
...
Bool_t TEventNumbers::QIsInComptonRange(Float_t Q,
					Int_t ch){
...
Float_t TEventNumbers::GetPhotoStartVal(int ch,
					int part,
					Bool_t onePart){
...
Float_t TEventNumbers::GetPedStartVal(){  
  return 600.0;
}

Long64_t TEventNumbers::GetnOR1(){  
  return nOR1;
}  

Long64_t TEventNumbers::GetnAND(){  
  return nAND;
}  

Long64_t TEventNumbers::GetnOR2(){  
  return nOR2;
}  

Long64_t TEventNumbers::GetEventSum(){  
  return eventSum;
}  

Bool_t TEventNumbers::GetOnePart(){  
  return onePart;
}  
